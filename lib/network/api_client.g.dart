...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<ForgetPasswordResponse> sendEmailToCheckIn(
    SendEmailToCheckRequest request,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<ForgetPasswordResponse> verifySentCode(
  ...
  @override
  Future<CategoriesResponseDto> getSubCategory(String categoryId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<PageableProductResponseDto> getProductList(
    String categoryId,
    int page, {
    int limit = 10,
  }) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PageableProductResponseDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/products',
    ...
    final _result = await _dio.fetch<dynamic>(_options);
    late PageableProductResponseDto _value;
    try {
      _value = PageableProductResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<CartResponseDto> getUserCartList() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<CartResponseDto> removeProductToCart(String productId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
